...
public record class Body : ModelBase
{
    ...
    public Body(Extract value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Body(Classify value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Body(Send value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Body(Split value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Body(Join value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Body(PayloadShaping value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Body(Enrich value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            case Enrich value:
                ...
                break;
            default:
                throw new BemInvalidDataException("Data did not match any variant of Body");
        }
    }
    ...
    )
    {
        return this.Value switch
        {
            ...
            _ => throw new BemInvalidDataException("Data did not match any variant of Body"),
        };
    }

    public static implicit operator Body(Extract value) => new(value);

    public static implicit operator Body(Classify value) => new(value);

    public static implicit operator Body(Send value) => new(value);

    public static implicit operator Body(Split value) => new(value);

    public static implicit operator Body(Join value) => new(value);

    public static implicit operator Body(PayloadShaping value) => new(value);

    public static implicit operator Body(Enrich value) => new(value);
...
public sealed record class Classify : JsonModel
{
    ...
    public IReadOnlyList<Classification>? Classifications
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<ImmutableArray<Classification>>(
                "classifications"
            );
        }
        init
