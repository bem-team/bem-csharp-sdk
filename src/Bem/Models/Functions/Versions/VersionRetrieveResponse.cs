...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public VersionRetrieveResponse(Function function)
        : this()
    {
...
public record class Function : ModelBase
{
    ...
    public Function(Extract value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public Function(Classify value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Function(Send value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Function(Split value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Function(Join value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Function(Enrich value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public Function(PayloadShaping value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public static implicit operator Function(Extract value) => new(value);

    public static implicit operator Function(Analyze value) => new(value);

    public static implicit operator Function(Classify value) => new(value);

    public static implicit operator Function(Send value) => new(value);

    public static implicit operator Function(Split value) => new(value);

    public static implicit operator Function(Join value) => new(value);

    public static implicit operator Function(Enrich value) => new(value);

    public static implicit operator Function(PayloadShaping value) => new(value);
...
public sealed record class Classify : JsonModel
{
    ...
    /// </summary>
    public required IReadOnlyList<Classification> Classifications
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<Classification>>(
                "classifications"
            );
        }
        init
        {
            this._rawData.Set<ImmutableArray<Classification>>(
                "classifications",
