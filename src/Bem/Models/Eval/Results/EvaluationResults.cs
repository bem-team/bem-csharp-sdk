...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EvaluationResults(EvaluationResults evaluationResults)
        : base(evaluationResults) { }
#pragma warning restore CS8618

    public EvaluationResults(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    EvaluationResults(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="EvaluationResultsFromRaw.FromRawUnchecked"/>
    public static EvaluationResults FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public EvaluationResults(JsonElement results)
        : this()
    {
...
class EvaluationResultsFromRaw : IFromRawJson<EvaluationResults>
{
    /// <inheritdoc/>
    public EvaluationResults FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        EvaluationResults.FromRawUnchecked(rawData);
}
