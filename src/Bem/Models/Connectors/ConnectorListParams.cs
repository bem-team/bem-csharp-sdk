...
public record class ConnectorListParams : ParamsBase
{
    ...
    ///
    /// <para>If both `workflowID` and `workflowName` are provided, results must match both.</para>
    /// </summary>
    public string? WorkflowID
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("workflowID");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("workflowID", value);
        }
    }
    ...
    public string? WorkflowName
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("workflowName");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("workflowName", value);
        }
    }
