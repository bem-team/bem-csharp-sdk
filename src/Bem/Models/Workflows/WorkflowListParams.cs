...
/// </summary>
public record class WorkflowListParams : ParamsBase
{
    ...
    public WorkflowListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WorkflowListParams(WorkflowListParams workflowListParams)
        : base(workflowListParams) { }
...
#pragma warning restore CS8618
    ...
    public static WorkflowListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(WorkflowListParams? other)
    {
        if (other == null)
        {
            return false;
