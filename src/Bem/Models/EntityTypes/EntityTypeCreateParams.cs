...
/// </summary>
public record class EntityTypeCreateParams : ParamsBase
{
    ...
    public EntityTypeCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EntityTypeCreateParams(EntityTypeCreateParams entityTypeCreateParams)
        : base(entityTypeCreateParams)
    {
        this._rawBodyData = new(entityTypeCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static EntityTypeCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(EntityTypeCreateParams? other)
    {
        if (other == null)
        {
            return false;
