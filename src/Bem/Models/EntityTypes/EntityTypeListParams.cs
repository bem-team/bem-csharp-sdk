...
public record class EntityTypeListParams : ParamsBase
{
    ...
    public string? ParentTypeID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("parentTypeId");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("parentTypeId", value);
        }
    }
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v3/entity-types")
        {
