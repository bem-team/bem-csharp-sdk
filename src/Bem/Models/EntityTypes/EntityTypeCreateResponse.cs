...
/// </summary>
[JsonConverter(
    typeof(JsonModelConverter<EntityTypeCreateResponse, EntityTypeCreateResponseFromRaw>)
)]
public sealed record class EntityTypeCreateResponse : JsonModel
{
    /// <summary>
    ...
    public EntityTypeCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EntityTypeCreateResponse(EntityTypeCreateResponse entityTypeCreateResponse)
        : base(entityTypeCreateResponse) { }
#pragma warning restore CS8618

    public EntityTypeCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    EntityTypeCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="EntityTypeCreateResponseFromRaw.FromRawUnchecked"/>
    public static EntityTypeCreateResponse FromRawUnchecked(
...
class EntityTypeCreateResponseFromRaw : IFromRawJson<EntityTypeCreateResponse>
{
    /// <inheritdoc/>
    public EntityTypeCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => EntityTypeCreateResponse.FromRawUnchecked(rawData);
}
