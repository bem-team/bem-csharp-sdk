...
public sealed record class ItemAddResponse : JsonModel
{
    ...
    /// </summary>
    public IReadOnlyList<ItemAddResponseItem>? Items
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<ImmutableArray<ItemAddResponseItem>>("items");
        }
        init
        {
            if (value == null)
            ...
            this._rawData.Set<ImmutableArray<ItemAddResponseItem>?>(
                "items",
...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ItemAddResponseItem, ItemAddResponseItemFromRaw>))]
public sealed record class ItemAddResponseItem : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public required ItemAddResponseItemData Data
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ItemAddResponseItemData>("data");
        }
    ...
    public ItemAddResponseItem() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ItemAddResponseItem(ItemAddResponseItem itemAddResponseItem)
        : base(itemAddResponseItem) { }
#pragma warning restore CS8618

    public ItemAddResponseItem(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ItemAddResponseItem(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ItemAddResponseItemFromRaw.FromRawUnchecked"/>
    public static ItemAddResponseItem FromRawUnchecked(
...
class ItemAddResponseItemFromRaw : IFromRawJson<ItemAddResponseItem>
{
    /// <inheritdoc/>
    public ItemAddResponseItem FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        ItemAddResponseItem.FromRawUnchecked(rawData);
}

/// <summary>
/// The data stored in this item
/// </summary>
[JsonConverter(typeof(ItemAddResponseItemDataConverter))]
public record class ItemAddResponseItemData : ModelBase
{
    ...
    public ItemAddResponseItemData(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ItemAddResponseItemData(JsonElement element)
    {
        this._element = element;
        this.Value = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new BemInvalidDataException(
                    "Data did not match any variant of ItemAddResponseItemData"
                );
        }
    }
    ...
    public static implicit operator ItemAddResponseItemData(string value) => new(value);

    public static implicit operator ItemAddResponseItemData(JsonElement value) => new(value);
    ...
    public virtual bool Equals(ItemAddResponseItemData? other) =>
        other != null
...
sealed class ItemAddResponseItemDataConverter : JsonConverter<ItemAddResponseItemData>
{
    public override ItemAddResponseItemData? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
