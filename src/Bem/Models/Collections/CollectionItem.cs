...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<CollectionItem, CollectionItemFromRaw>))]
public sealed record class CollectionItem : JsonModel
{
    /// <summary>
...
#pragma warning restore CS8618
    ...
    public CollectionItem(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    CollectionItem(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="CollectionItemFromRaw.FromRawUnchecked"/>
    public static CollectionItem FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class CollectionItemFromRaw : IFromRawJson<CollectionItem>
{
    /// <inheritdoc/>
    public CollectionItem FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        CollectionItem.FromRawUnchecked(rawData);
}
