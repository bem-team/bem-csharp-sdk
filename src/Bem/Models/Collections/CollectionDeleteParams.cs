...
/// </summary>
public record class CollectionDeleteParams : ParamsBase
{
    /// <summary>
    ...
    public CollectionDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CollectionDeleteParams(CollectionDeleteParams collectionDeleteParams)
        : base(collectionDeleteParams) { }
...
#pragma warning restore CS8618
    ...
    public static CollectionDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CollectionDeleteParams? other)
    {
        if (other == null)
        {
            return false;
