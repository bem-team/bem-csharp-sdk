...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<BucketCreateResponse, BucketCreateResponseFromRaw>))]
public sealed record class BucketCreateResponse : JsonModel
{
    /// <summary>
    ...
    public BucketCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BucketCreateResponse(BucketCreateResponse bucketCreateResponse)
        : base(bucketCreateResponse) { }
#pragma warning restore CS8618

    public BucketCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    BucketCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="BucketCreateResponseFromRaw.FromRawUnchecked"/>
    public static BucketCreateResponse FromRawUnchecked(
...
class BucketCreateResponseFromRaw : IFromRawJson<BucketCreateResponse>
{
    /// <inheritdoc/>
    public BucketCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => BucketCreateResponse.FromRawUnchecked(rawData);
}
