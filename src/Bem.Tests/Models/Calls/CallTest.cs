...
public class CallTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<Errors::ErrorEvent> expectedErrors =
        [
            new()
            {
                EventID = "eventID",
...
public class OutputTest : TestBase
{
    ...
    {
        Output value = new SplitCollection()
        {
            EventID = "eventID",
            FunctionID = "functionID",
            FunctionName = "functionName",
    ...
    {
        Output value = new Errors::ErrorEvent()
        {
            EventID = "eventID",
            FunctionID = "functionID",
            FunctionName = "functionName",
    ...
    {
        Output value = new CollectionProcessing()
        {
...
public class TransformTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        string expectedCallID = "callID";
        CorrectedContent expectedCorrectedContent = new CorrectedContentOutput()
        {
            Output = [JsonSerializer.Deserialize<JsonElement>("{}")],
        };
        DateTimeOffset expectedCreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z");
...
{
    [Fact]
    public void CorrectedContentOutputValidationWorks()
    {
        CorrectedContent value = new CorrectedContentOutput()
        {
            Output = [JsonSerializer.Deserialize<JsonElement>("{}")],
        };
        value.Validate();
    ...
    [Fact]
    public void CorrectedContentOutputSerializationRoundtripWorks()
    {
        CorrectedContent value = new CorrectedContentOutput()
        {
            Output = [JsonSerializer.Deserialize<JsonElement>("{}")],
...
public class CorrectedContentOutputTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CorrectedContentOutput
        {
            Output = [JsonSerializer.Deserialize<JsonElement>("{}")],
        };

        List<Outputs::AnyType?> expectedOutput = [JsonSerializer.Deserialize<JsonElement>("{}")];
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CorrectedContentOutput>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CorrectedContentOutput copied = new(model);
...
public class CallInputTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CallInput
        {
            BatchFiles = new()
            {
                Inputs =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CallInput>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<CallInput>(
            element,
            ModelBase.SerializerOptions
        );
        Assert.NotNull(deserialized);
