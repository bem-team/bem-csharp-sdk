...
public class EntityTypeCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntityTypeCreateResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<EntityTypeCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntityTypeCreateResponse copied = new(model);
