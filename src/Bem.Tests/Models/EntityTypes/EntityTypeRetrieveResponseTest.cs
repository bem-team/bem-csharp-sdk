...
public class EntityTypeRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new EntityTypeRetrieveResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<EntityTypeRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntityTypeRetrieveResponse copied = new(model);
