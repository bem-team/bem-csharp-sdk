...
public class ReviewerAssignResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ReviewerAssignResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ReviewerAssignResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ReviewerAssignResponse copied = new(model);
