...
public class BucketUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BucketUpdateResponse
        {
            BucketID = "bucketID",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BucketUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BucketUpdateResponse copied = new(model);
