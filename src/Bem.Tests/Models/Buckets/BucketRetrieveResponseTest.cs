...
public class BucketRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BucketRetrieveResponse
        {
            BucketID = "bucketID",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BucketRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BucketRetrieveResponse copied = new(model);
