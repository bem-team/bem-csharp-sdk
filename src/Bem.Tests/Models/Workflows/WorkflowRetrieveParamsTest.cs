...
public class WorkflowRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new WorkflowRetrieveParams { WorkflowName = "workflowName" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        WorkflowRetrieveParams copied = new(parameters);
