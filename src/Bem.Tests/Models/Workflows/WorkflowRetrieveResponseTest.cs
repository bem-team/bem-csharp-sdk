...
public class WorkflowRetrieveResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        WorkflowRetrieveResponseWorkflow expectedWorkflow = new()
        {
            ID = "id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Edges =
...
public class WorkflowRetrieveResponseWorkflowTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WorkflowRetrieveResponseWorkflow
        {
            ID = "id",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Edges =
        ...
        List<WorkflowRetrieveResponseWorkflowEdge> expectedEdges =
        [
            new()
            {
                DestinationNodeName = "destinationNodeName",
        ...
        List<WorkflowRetrieveResponseWorkflowNode> expectedNodes =
        [
            new()
            {
                Function = new()
        ...
        WorkflowRetrieveResponseWorkflowAudit expectedAudit = new()
        {
            VersionCreatedBy = new()
            {
                CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WorkflowRetrieveResponseWorkflow>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WorkflowRetrieveResponseWorkflow copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WorkflowRetrieveResponseWorkflowEdgeTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WorkflowRetrieveResponseWorkflowEdge
        {
            DestinationNodeName = "destinationNodeName",
            SourceNodeName = "sourceNodeName",
            DestinationName = "destinationName",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WorkflowRetrieveResponseWorkflowEdge>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WorkflowRetrieveResponseWorkflowEdge copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WorkflowRetrieveResponseWorkflowNodeTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WorkflowRetrieveResponseWorkflowNode
        {
            Function = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WorkflowRetrieveResponseWorkflowNode>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WorkflowRetrieveResponseWorkflowNode copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class WorkflowRetrieveResponseWorkflowAuditTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new WorkflowRetrieveResponseWorkflowAudit
        {
            VersionCreatedBy = new()
            {
                CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<WorkflowRetrieveResponseWorkflowAudit>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WorkflowRetrieveResponseWorkflowAudit copied = new(model);
