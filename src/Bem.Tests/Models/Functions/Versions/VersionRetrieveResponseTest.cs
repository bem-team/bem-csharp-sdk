...
public class FunctionTest : TestBase
{
    ...
    {
        Function value = new PayloadShaping()
        {
            FunctionID = "functionID",
            FunctionName = "functionName",
