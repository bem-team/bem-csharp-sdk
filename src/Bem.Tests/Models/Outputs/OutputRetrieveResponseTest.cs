...
public class OutputRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new OutputRetrieveResponse
        {
        ...
        Output expectedOutput = new Transform()
        {
            EventID = "eventID",
            FunctionID = "functionID",
            FunctionName = "functionName",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<OutputRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        OutputRetrieveResponse copied = new(model);
