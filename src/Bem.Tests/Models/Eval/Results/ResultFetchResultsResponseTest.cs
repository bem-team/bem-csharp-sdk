...
public class ResultFetchResultsResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ResultFetchResultsResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ResultFetchResultsResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ResultFetchResultsResponse copied = new(model);
