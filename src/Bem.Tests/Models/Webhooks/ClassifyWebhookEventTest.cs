...
public class ClassifyWebhookEventTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ClassifyWebhookEvent
        {
            Choice = "choice",
            EventID = "eventID",
        ...
        ApiEnum<string, ClassifyWebhookEventEventType> expectedEventType =
            ClassifyWebhookEventEventType.Classify;
        ...
        ClassifyWebhookEventMetadata expectedMetadata = new()
        {
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyWebhookEvent copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ClassifyWebhookEventEventTypeTest : TestBase
{
    [Theory]
    [InlineData(ClassifyWebhookEventEventType.Classify)]
    public void Validation_Works(ClassifyWebhookEventEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyWebhookEventEventType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, ClassifyWebhookEventEventType>>(
    ...
    [Theory]
    [InlineData(ClassifyWebhookEventEventType.Classify)]
    public void SerializationRoundtrip_Works(ClassifyWebhookEventEventType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyWebhookEventEventType> value = rawValue;
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, ClassifyWebhookEventEventType>
...
public class ClassifyWebhookEventMetadataTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ClassifyWebhookEventMetadata { DurationFunctionToEventSeconds = 0 };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ClassifyWebhookEventMetadata>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ClassifyWebhookEventMetadata { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyWebhookEventMetadata copied = new(model);
